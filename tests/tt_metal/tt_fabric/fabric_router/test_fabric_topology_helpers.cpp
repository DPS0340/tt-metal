...
TEST(FabricTopologyHelpers, FabricTypeFactoriesCollapseSizeTwoTorusDimensions) {
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{1, 8}), FabricType::TORUS_X);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{8, 1}), FabricType::TORUS_Y);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_Y, false, MeshShape{2, 4}), FabricType::MESH);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{2, 4}), FabricType::TORUS_X);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_X, false, MeshShape{4, 2}), FabricType::MESH);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{4, 2}), FabricType::TORUS_Y);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{2, 2}), FabricType::MESH);
    EXPECT_EQ(get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{8, 4}), FabricType::TORUS_XY);

    EXPECT_FALSE(requires_more_connectivity(
        get_fabric_type(FabricConfig::FABRIC_2D_TORUS_Y, false, MeshShape{2, 4}), FabricType::MESH));
    EXPECT_FALSE(requires_more_connectivity(
        get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{2, 4}), FabricType::TORUS_X));
    EXPECT_TRUE(requires_more_connectivity(
        get_fabric_type(FabricConfig::FABRIC_2D_TORUS_XY, false, MeshShape{8, 4}), FabricType::MESH));
}
